function [rel_infeas_err,rel_subopt_err,time_period,iter_epoch,oracle]=...
    APDB_sc(input,optval,x0,y0,stop_criteria,max_iter)
%************************************************************
...
%
% The step-sizes are non-constant according to   
% Theorem 2.1 part (II) in the paper https://arxiv.org/pdf/1803.01401.pdf.
%************************************************************
